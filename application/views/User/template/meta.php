...
<head>
    ...
    <!-- custom css -->
    <link rel="stylesheet" href="<?= base_url('assets/back/'); ?>plugins/custom-css/styles.css">
</head>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="<?= base_url('assets/back/'); ?>dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
        </div>